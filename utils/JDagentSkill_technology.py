...
def find_required_point(state):
    ...
    template="""
        ...
        ***Ensure don't consider technology or skill if not mention in job description.***
        For each skill, map the associated technology. If no specific tool is mentioned, set "Technology: No specific tool".  If no specific Skill is mentioned, set "Skill: No specific skill". 

        Ensure always consider programming languages as technology and not consider in skill.

        Extract and categorize the following information into two groups:  
        1. *Skill* (General capabilities, methodologies, or soft skills).  
        2. *Technology* (Specific tools, platforms, programming languages or frameworks).  

        make two category skill and technology mapped the data to each other
        # Example Output :
        # 1. Skill: Manual Testing  
        # Technology: No specific tool  

        # 2. Skill: Automation Testing  
        # Technology: Selenium, TestNG   
...
def check_required_point(state):
    ...
    template = """
        ...
        Skills (required): [Final Verified Required Skills]
        ...
        Skills (required): Extracted "React" (required).
...
def find_preferred_point(state):
    ...
    template="""  
        ...
        For each skill, map the associated technology. If no specific tool is mentioned, set "Technology: No specific tool".  
        ...
        Extract and categorize the following information into two groups:  
        1. *Skill* (General capabilities, methodologies, or soft skills).  
        2. *Technology* (Specific tools, platforms, languages or frameworks).  
...
def check_preferred_point(state):
    ...
    template = """  
        ...
        **Output Format:**  
        ...
        Skills (preferred): [Final Verified Preferred Skills]  
...
def generate_final_point_tool(state):
    ...
    template="""
        ...
        Output Format:
            ...
            Exclude Location, Experience, Graduation, Post Graduation, PhD, Skills and Tools from the output if they are N/A, None, or empty
