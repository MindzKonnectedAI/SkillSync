...
def pdf_folder(uploaded_file,container,folder_path):
...
def upload_rule_data(uploaded_file,container,folder_path, view_pdf_path):
    # folder_path = "./ruleData"
    ...
    pdf_folder(uploaded_file,container,view_pdf_path)
